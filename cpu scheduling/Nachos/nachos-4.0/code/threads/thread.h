...
class Thread {
  ...
  public:
    ...
    // set and get the burst time, start time and priority of a thread
  ...
  private:
    ...
    // define burst time, start time and priority
    int burstTime; // the time that a thread takes to execute
    int startTime; // the time that a thread start to execute
    int execPriority; // the priority that a thread possesses to execute 
